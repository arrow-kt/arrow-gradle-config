...
/**
 * This methods gives you all info available for a detected `CodeBlock`. It **does not** filter the
 * list, but if you return a non-null value it will update the existing value in the [DModule]
 */
...
private suspend fun DClasslike.process(
  ...
  when (this) {
    ...
    is DAnnotation ->
      copy(documentation = documentation.process(module, `package`, this, transform))
  }
