            ...
            if (file("src/commonMain/kotlin").exists()) {
                ...
                named("commonMain") {
                    ...
                    sourceLink {
                        ...
                        remoteUrl.set(
                            uri("$arrowMainUrl/${relativeProjectPath("src/commonMain/kotlin")}")
                                .toURL()
                        )
                ...
                named("main") {
                    ...
                    sourceLink {
                        ...
                        remoteUrl.set(
                            uri("$arrowMainUrl/${relativeProjectPath("src/main/kotlin")}").toURL()
                        )
                        remoteLineSuffix.set("#L")
                    }
                }
            ...
            if (file("src/jvmMain/kotlin").exists()) {
                named("jvmMain") {
                    ...
                    sourceLink {
                        ...
                        remoteUrl.set(
                            uri("$arrowMainUrl/${relativeProjectPath("src/jvmMain/kotlin")}")
                                .toURL()
                        )
                        remoteLineSuffix.set("#L")
                    }
            ...
            if (file("src/jsMain/kotlin").exists()) {
                named("jsMain") {
                    ...
                    sourceLink {
                        ...
                        remoteUrl.set(
                            uri("$arrowMainUrl/${relativeProjectPath("src/jsMain/kotlin")}").toURL()
                        )
                        remoteLineSuffix.set("#L")
                    }
                }
